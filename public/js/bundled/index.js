...
var _mapLeaflet = require("./map_leaflet");
var _updateUserAccount = require("./updateUserAccount");
...
if (mapDiv) {
    ...
    (0, _mapLeaflet.renderMap)(locations);
}
...
if (userAccountUpdateForm) userAccountUpdateForm.addEventListener("submit", (e)=>{
    e.preventDefault();
    ...
    (0, _updateUserAccount.updateData)(form, "data");
// RELOAD THE PAGE TO SEE THE CHANGES
});
if (userPasswordUpdateForm) userPasswordUpdateForm.addEventListener("submit", (e)=>{
    e.preventDefault();
    const currentPassword = document.getElementById("password-current").value;
    const newPassword = document.getElementById("password").value;
    const newPasswordConfirm = document.getElementById("password-confirm").value;
    (0, _updateUserAccount.updateData)({
        currentPassword,
        newPassword,
        newPasswordConfirm
    }, "password");
...
},{"./login":"7yHem","./map_leaflet":"6tYza","@babel/polyfill":"dTCHC","./updateUserAccount":"kpT8A","./stripe":"10tSC"}],"7yHem":[function(require,module,exports) {
...
const login = (email, password)=>{
    ...
    fetch(url, {
        ...
        if (data.status === "success") {
            (0, _alerts.displayAlert)("Logged in successfully", "success");
            location.assign("/"); // redirects to homepage
        } else (0, _alerts.displayAlert)(data.message, "error");
    }).catch((err)=>{
...
const logout = ()=>{
    ...
    fetch(url).then((res)=>res.json()).then((data)=>{
        ...
        (0, _alerts.displayAlert)(err.message, "error");
    });
};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./alerts":"6Mcnf"}],"gkKU3":[function(require,module,exports) {
...
parcelHelpers.export(exports, "displayAlert", ()=>displayAlert);
const hideAlert = ()=>{
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6tYza":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{}],"kpT8A":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "updateData", ()=>updateData);
var _alerts = require("./alerts");
const updateData = (data1, type)=>{
    ...
    fetch(url, {
        ...
        if (data.status !== "success") (0, _alerts.displayAlert)(data.message, "error");
        else (0, _alerts.displayAlert)(`${type.toUpperCase()} updated successfully`, "success");
    }).catch((err)=>{
        (0, _alerts.displayAlert)(err.message, "error");
    });
};
...
const bookTour = async (tourId)=>{
    ...
    try {
        ...
        } else (0, _alerts.displayAlert)("Something went wrong", "error");
    } catch (err) {
        console.log(err);
        (0, _alerts.displayAlert)(err, "error");
    }
};

},{"./alerts":"6Mcnf","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["4V44L","f2QDv"], "f2QDv", "parcelRequireda5e")
